...
const ValidationsPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-title-sm font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-gray-900 to-[#683b77] dark:from-white dark:to-[#ab78c3]">Validations</h1>
